...
玩家从30岁登基开始，在主城区处理来自五州的奏折，使用圣旨和政策技能，管理四大势力与国家资源，并至少完整运行12个月。最终目标是验证“决策 → 后果 → 新问题”的循环是否好玩。
...
**验收：** 页面显示“景和元年·正月 / 皇帝30岁”，控制台可看到完整 GameState。
...
原始文档记录的是最初的 Sprint 1 里程碑；当前可运行 prototype 已推进到 V0.3“建国危局与五年求生”阶段。实现状态以 `prototype/README.md` 和实际代码为准。

完成后再进入 Sprint 2。

V0.1 的目的不是证明游戏“已经完成”，而是证明：
